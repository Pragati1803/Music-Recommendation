...
st.markdown("""
    <footer style="background: linear-gradient(135deg, #7289DA, #40444B); padding: 20px; border-radius: 8px; position: relative;">
        <div style="animation: fade-in 2s; text-align: center;">
            <p style="color: white; font-size: 18px;">Made with ❤️ by Pragati, 2024 | This project uses the Spotify API</p>
...
st.markdown("""
    ...
    <h3>8. Contact Me</h3>
    <p>If you have any questions or concerns about this Privacy Policy, please contact me at [srivastavapragati699@gmail.com].</p>
""", unsafe_allow_html=True)
